...
2. **Скрипт** — [`.cursor/presentations/scripts/polza_marp_images.py`](../../presentations/scripts/polza_marp_images.py): утилиты слайдов, `build_image_prompt`, **`generate_image_polza()`**, CLI `generate`.
...
- Палитра из `.cursor/presentations/DESIGN_TOKENS.md` / `semanticTokens` в JSON.
